...
class Grafo:
    ...
    # Graficar grafo by IA
    def graficar_grafo(self, distancia_total: int, camino_resaltado: list = []):
        ...
        # Circular para garantizar distancias equidistantes
        ...
        plt.title("Grafo con el camino más corto resaltado", fontsize=16, fontweight='bold')
        plt.show()
...
if __name__ == "__main__":
    ...
    if distancia < float('inf'):
        ...
        grafo.graficar_grafo(distancia, camino_resaltado=camino)
    else:
